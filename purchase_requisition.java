...
//        }
    ...
    public void fillComboBOx(){
        poclass po = new poclass("C:\\Users\\Asus\\OneDrive\\Desktop\\yushyang\\OODJ\\purchase_requisition.txt");///记得跟calvin拿supplier 的txt file
        try {
            ArrayList<String> as = po.readData();
        ...
        for (int i = 1; i < as.size(); i++) {
            String line = as.get(i);
            String[] dataRow = line.split("/");
            String company = dataRow[4].toString();
